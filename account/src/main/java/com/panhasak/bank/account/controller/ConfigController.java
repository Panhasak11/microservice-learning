...
import com.panhasak.bank.account.config.AccountServiceConfig;
import com.panhasak.bank.account.properties.Properties;
...
public class ConfigController {
	...
	public String getProperties() throws JsonProcessingException{
		...
		Properties properties = new Properties(serviceConfig.getMsg(),serviceConfig.getBuildVersion(),
				 serviceConfig.getMailDetail(),serviceConfig.getActiveBranches());
